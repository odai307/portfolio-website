...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await fetch('https://formsubmit.co/ajax/gabrielafotey@gmail.com', {
        method: 'POST',
        headers: { 
  ...
  return (
    <section id="contact" className="py-24 relative overflow-hidden bg-[#030908]">
      {/* Background glow */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-12 max-w-5xl mx-auto items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="glass-panel rounded-2xl p-6 border border-emerald-500/20 space-y-5">
              ...
              <div className="space-y-4 text-sm text-slate-300">
                <div className="flex items-center gap-3 p-3 rounded-xl bg-[#061411] border border-emerald-500/20">
                ...
                <div className="flex items-center gap-3 p-3 rounded-xl bg-[#061411] border border-emerald-500/20">
                  ...
                  <div>
                    ...
                    <a href="mailto:gabrielafotey@gmail.com" className="font-medium text-emerald-300 hover:underline">
            ...
            <div className="glass-panel rounded-2xl p-7 border border-emerald-500/20">
              {submitted ? (
                <div className="text-center py-12 space-y-4">
                  <div className="w-16 h-16 rounded-full bg-emerald-500/10 border border-emerald-500/25 text-emerald-400 flex items-center justify-center mx-auto">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 rounded-full bg-[#091a16] border border-emerald-500/25 text-slate-300 text-xs font-medium hover:text-white mt-4"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#061411] border border-emerald-500/25 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-emerald-500 transition-colors"
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full bg-[#061411] border border-emerald-500/25 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-emerald-500 transition-colors resize-none"
                    ></textarea>
                  </div>

                  <button
                    type="submit"
                    className="w-full py-4 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 text-slate-950 font-bold text-sm hover:opacity-95 transition-opacity shadow-lg shadow-emerald-500/20 flex items-center justify-center gap-2 cursor-pointer"
                  >
